...
<template>
  ...
  <nav class="bg-white dark:bg-gray-900 fixed w-full z-20 top-0 left-0 border-b border-gray-200 dark:border-gray-600" style="background-color:#805d49;height:92px">
    <div class="flex flex-wrap items-center justify-between mx-auto p-4">
      ...
      <!-- Dropdown menu -->
      <div id="userDropdown"
        class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-60  dark:bg-gray-700 dark:divide-gray-600" style="border: 1px solid #000; padding:10px; ">
        ...
        <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="avatarButton">
          <router-link :to="{ name: 'adminhome' }">
            <div class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">承認されたリスト</div>
          </router-link>
        </ul>
        <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="avatarButton">
