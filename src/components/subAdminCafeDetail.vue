  ...
  <div class="container" style="width: 85%; padding-left: 40px">
    <div class="grid grid-cols-2 gap-5" style="padding-top: 5%">
      ...
      <div class="grid-cols-1">
        <div class="w-full flex justify-end">
          <router-link
            :to="{ name: 'UpdateCoffee', params: { id: cafe.id } }"
    ...
    <div>
      ...
      <div v-if="cafe.isOpen">
        <div>
          <font-awesome-icon style="color: #805d49" icon="clock" />
      ...
      <div v-if="!cafe.isOpen">
        <div>
          <font-awesome-icon style="color: #805d49" icon="clock" />
          {{ cafe.time_open }}-{{ cafe.time_close }} -
          <span style="font-weight: 700"> 閉店 </span>
        </div>
      </div>
      <p>
      ...
      <p style="font-style: italic; font-size: 14px" v-else>
        エアコン：きいていない
      </p>
